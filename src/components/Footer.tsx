...
const navigation = {
  ...
  social: [
    {
      name: "Twitter",
      href: "https://twitter.com/RealityHaushq",
      icon: (
    ...
    {
      name: "LinkedIn",
      href: "https://linkedin.com/company/RealityHaushq",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
    ...
    {
      name: "Email",
      href: "mailto:hello@RealityHaushq.com",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    <footer id="contact" className="bg-white">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center text-md leading-5 text-zinc-500">
          &copy; 2023 RealityHaus Labs. All rights reserved. <br />
          RealityHaus Labs are trademarks of RealityHaus Technologies.
        </p>
      </div>
    </footer>
  );
